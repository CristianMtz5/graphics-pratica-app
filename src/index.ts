...
function vp(dTheta: number, dPhi: number, fRho: number): void {
  ...
  if (obj != undefined) {
    ...
    if (!obj.vp(cv, dTheta, dPhi, fRho)) alert("datos no validos");
  } else alert("aun no has leido un archivo");
}
...
document
  .getElementById("eyeDown")
  .addEventListener("click", eyeDownFunc, false);
document.getElementById("eyeUp").addEventListener("click", eyeUpFunc, false);
document
  .getElementById("eyeLeft")
  .addEventListener("click", eyeLeftFunc, false);
document
  .getElementById("eyeRight")
  .addEventListener("click", eyeRightFunc, false);
document
  .getElementById("incrDist")
  .addEventListener("click", incrDistFunc, false);
document
  .getElementById("decrDist")
  .addEventListener("click", decrDistFunc, false);

//movimiento de piezas
document
  .getElementById("pza1Izq")
  .addEventListener("click", pza1IzqFunc, false);
document
  .getElementById("pza1Der")
  .addEventListener("click", pza1DerFunc, false);
document
  .getElementById("pza12Izq")
  .addEventListener("click", pza12IzqFunc, false);
document
  .getElementById("pza12Der")
  .addEventListener("click", pza12DerFunc, false);
