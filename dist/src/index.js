...
function girarHelices() {
    let af = 10;
    Rota3D.initRotate(obj.w[170], obj.w[214], (af * Math.PI) / 180);
...
let intervaloH;
function pza1Der() {
    intervaloH = setInterval(girarHelices, 100);
}
function pza12Der() {
...
document.getElementById('pza1Izq').addEventListener('click', girarHelices, false);
document.getElementById('pza1Der').addEventListener('click', pza1Der, false);
document.getElementById('pza12Der').addEventListener('click', pza12Der, false);
let Pix, Piy;
let Pfx, Pfy;
